...
export const SCREENBACKGROUND = 'screenBackground';
...
export const SettingsFields: SettingsMeta = [
    ...
    { id: BOARDBACKGROUND, inputType: 'file', label: 'Board Background' },
    { id: SCREENBACKGROUND, inputType: 'file', label: 'Screen Background'}
]